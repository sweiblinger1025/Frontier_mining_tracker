...
RECIPE_DATA = [
    ...
    {"workbench": "CNC Mill", "output": "Stepper Motor", "output_qty": 1,
     "inputs": [("Electronic Parts", 2), ("Steel Bar", 1), ("Gear", 1)]},
    {"workbench": "CNC Mill", "output": "Cam Axle", "output_qty": 1,
     "inputs": [("Steel Bar", 1), ("Steel Rod", 1)]},
