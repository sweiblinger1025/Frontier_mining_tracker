...
RECIPE_DATA = [
    ...
    {"workbench": "Wood Workbench", "output": "Wood Roof", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Corner (Inside)", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Corner (Outside)", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Ramp 1/4", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Ramp 2/4", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Ramp 3/4", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    {"workbench": "Wood Workbench", "output": "Wood Ramp 4/4", "output_qty": 1,
     "inputs": [("Wood Beam", 2), ("Wood Plank", 2)]},
    ...
    {"workbench": "Concrete Mixer", "output": "Concrete Block", "output_qty": 1,
     "inputs": [("Water", 4), ("Cement", 8)], "notes": "Rough/Standard/Polished variants"},
    # Floor/Wall/Roof
    {"workbench": "Concrete Mixer", "output": "Concrete Floor", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Wall", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Cut Wall", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 2)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Roof", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    # Corners
    {"workbench": "Concrete Mixer", "output": "Concrete Corner Inside", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Corner Outside", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    # Ramps
    {"workbench": "Concrete Mixer", "output": "Concrete Ramp 1/4", "output_qty": 1,
     "inputs": [("Water", 3), ("Cement", 7)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Ramp 2/4", "output_qty": 1,
     "inputs": [("Water", 3), ("Cement", 6)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Ramp 3/4", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 5)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Ramp 4/4", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    # Roof corners
    {"workbench": "Concrete Mixer", "output": "Concrete Roof Corner Inside", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    {"workbench": "Concrete Mixer", "output": "Concrete Roof Corner Outside", "output_qty": 1,
     "inputs": [("Water", 2), ("Cement", 4)], "notes": "Rough/Standard/Polished variants"},
    ...
    {"workbench": "CNC Cutter", "output": "Steel Mesh", "output_qty": 1,
    ...
    # Doors
    {"workbench": "CNC Cutter", "output": "Steel Door (Small)", "output_qty": 1,
     "inputs": [("Steel Beam", 2), ("Steel Plate", 5), ("Steel Rod", 2), ("Bolts & Nuts", 2)]},
    {"workbench": "CNC Cutter", "output": "Steel Door (Large)", "output_qty": 1,
     "inputs": [("Steel Beam", 2), ("Steel Plate", 6), ("Bolts & Nuts", 8)]},
    # Structural
    {"workbench": "CNC Cutter", "output": "Steel Stairs", "output_qty": 1,
     "inputs": [("Steel Beam", 2), ("Steel Plate", 3)]},
    {"workbench": "CNC Cutter", "output": "Steel Ramp 1/4", "output_qty": 1,
     "inputs": [("Steel Beam", 4), ("Steel Plate", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Ramp 2/4", "output_qty": 1,
     "inputs": [("Steel Beam", 4), ("Steel Plate", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Ramp 3/4", "output_qty": 1,
     "inputs": [("Steel Beam", 3), ("Steel Plate", 3)]},
    {"workbench": "CNC Cutter", "output": "Steel Ramp 4/4", "output_qty": 1,
     "inputs": [("Steel Beam", 2), ("Steel Plate", 2)]},
    # Corners & Roof
    {"workbench": "CNC Cutter", "output": "Steel Corner Inside", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Corner Outside", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Roof", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Roof Corner Inside", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Roof Corner Outside", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    # Windows
    {"workbench": "CNC Cutter", "output": "Steel Wall Window", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    {"workbench": "CNC Cutter", "output": "Steel Wall Double Window", "output_qty": 1,
     "inputs": [("Steel Rod", 4), ("Bolts & Nuts", 4)]},
    # Quest
    ...
    {"workbench": "CNC Mill", "output": "Battery", "output_qty": 1,
     "inputs": [("Plastic", 1), ("Lithium", 3)]},
    # Filters & Tires
    {"workbench": "CNC Mill", "output": "Air Filter", "output_qty": 1,
     "inputs": [("Electronic Parts", 2), ("Aluminum", 1)]},
    {"workbench": "CNC Mill", "output": "Tire", "output_qty": 1,
     "inputs": [("Plastic", 1), ("Steel", 2)]},
    # Hydraulics
    {"workbench": "CNC Mill", "output": "Hydraulic Hose", "output_qty": 1,
     "inputs": [("Rubber", 2), ("Steel", 5)]},
    {"workbench": "CNC Mill", "output": "Hydraulic Pump", "output_qty": 1,
     "inputs": [("Steel", 3), ("Large Drive Axle", 1), ("Gear", 2), ("Bearing", 2)]},
    # Engine
    {"workbench": "CNC Mill", "output": "Engine Head", "output_qty": 1,
     "inputs": [("Iron", 20)]},
    {"workbench": "CNC Mill", "output": "Turbo", "output_qty": 1,
    ...
    # Drive Axles
    {"workbench": "CNC Mill", "output": "Small Drive Axle", "output_qty": 1,
     "inputs": [("Steel", 3), ("Gear", 2), ("Bearing", 2)]},
    {"workbench": "CNC Mill", "output": "Medium Drive Axle", "output_qty": 1,
     "inputs": [("Steel", 5), ("Gear", 3), ("Bearing", 3)]},
    {"workbench": "CNC Mill", "output": "Large Drive Axle", "output_qty": 1,
     "inputs": [("Steel", 8), ("Gear", 4), ("Bearing", 4)]},
    # Brakes
    {"workbench": "CNC Mill", "output": "Small Brake", "output_qty": 1,
     "inputs": [("Steel", 2), ("Rubber", 1)]},
    {"workbench": "CNC Mill", "output": "Medium Brake", "output_qty": 1,
     "inputs": [("Steel", 3), ("Rubber", 2)]},
    {"workbench": "CNC Mill", "output": "Large Brake", "output_qty": 1,
     "inputs": [("Steel", 5), ("Rubber", 3)]},
    # Exhaust & Cooling
    {"workbench": "CNC Mill", "output": "Exhaust", "output_qty": 1,
     "inputs": [("Steel", 3), ("Aluminum", 2)]},
    {"workbench": "CNC Mill", "output": "Radiator", "output_qty": 1,
     "inputs": [("Aluminum", 5), ("Copper", 3)]},
    # Quest
